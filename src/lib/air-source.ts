...
export function isLocalAirForecast(beach: Pick<BeachViewModel, 'name'>, forecast: DailyBeachForecast): boolean {
  ...
  return forecast.airMatchType === 'municipality' ||
    (forecast.airMatchType === undefined && forecast.airDistanceKm === 0)
}
